...
from sqlalchemy import Boolean, DateTime, ForeignKey, Integer, String, Index, UniqueConstraint, text
...
class BookAsset(Base):
    ...
    __table_args__ = (
        UniqueConstraint("book_id", "asset_type", "version", name="uq_book_asset_version"),
        Index(
