...
app = FastAPI(
    ...
    openapi_tags=[
        ...
        {
            "name": "books",
            "description": "Public catalog, discovery/facets, admin catalog management.",
        },
        {
            "name": "collections",
            "description": "Curated archival collections and their public catalogue boundary.",
        },
        {
            "name": "library",
            "description": "A user's personal shelf and reading progress.",
        },
...
app.mount(
    "/static/avatars", StaticFiles(directory=AVATAR_STORAGE_DIR), name="avatar-files"
)
app.mount(
    "/static/covers", StaticFiles(directory=COVERS_STORAGE_DIR), name="cover-files"
)
app.mount(
    "/static/assets", StaticFiles(directory=STATIC_ASSET_DIR), name="static-assets"
)
